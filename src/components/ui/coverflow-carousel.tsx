    ...
    >
      <div className="relative">
        <div
          ...
          className="cursor-grab overflow-hidden py-4 outline-none ring-ring focus-visible:ring-2 active:cursor-grabbing select-none"
          style={{
            ...
            {slides.map((slide, index) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    if (!dragRef.current?.hasMoved && index !== selected) {
                      goTo(index);
                    }
                  }}
                  className={cn(
